# Operator Quickstart — Support Services To Forestry Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0240** (`cloud-itonami-isic-0240`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0240.git
cd cloud-itonami-isic-0240
```
...
- Blueprint governor key: `forestrysupport-governor`
- Likely source path: `forestrysupport.governor.cljc`
