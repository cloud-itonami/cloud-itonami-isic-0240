# Business Model: Support Services To Forestry Coordination
...
## Classification
- Repository: `cloud-itonami-isic-0240` ([github.com/cloud-itonami/cloud-itonami-isic-0240](https://github.com/cloud-itonami/cloud-itonami-isic-0240))
- ISIC Rev.5: `0240` — Support Services To Forestry Coordination
- Domain: `:forestry/support-services`
- Social impact: :forest-health :fire-risk-reduction :contract-labor-efficiency
- Actor: `:forestrysupport-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :forestry/support-services — who wants
...
One managed tenant (:forestry/support-services):
...
- Do not bypass the `:forestrysupport-governor` for production decisions.
